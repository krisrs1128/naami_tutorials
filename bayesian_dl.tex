...
\begin{frame}
  ...
  \item 1D version of mixture of Gaussians
  \end{itemize}
  \begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\paperwidth]{figure/1d_mog_points}
  \end{figure}
...
\begin{frame}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\paperwidth]{figure/1d_mog_assignments}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\paperwidth]{figure/1d_mog_overlaid}
  \end{figure}
\end{frame}
