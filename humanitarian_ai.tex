...
\usepackage{pythonhighlight, subcaption, natbib, hyperref}
\hypersetup{
    colorlinks=true,
    linkcolor=blue,
    filecolor=magenta,      
...
\begin{frame}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\paperwidth]{figure/jakarta_traffic}
...
\begin{frame}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\paperwidth]{figure/land_cover}
...
\begin{frame}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\paperwidth]{figure/hotsm}
...
\begin{frame}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\paperwidth]{figure/whitefly}
...
\begin{frame}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\paperwidth]{figure/ubenwa}
...
\begin{frame}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\paperwidth]{figure/lead}
